...
<div class="card p-4 bg-light">
	<div class="card-header">
		<h1 class="text-center">Eliminación del producto</h1>
	</div>
	<div class="card-body">
		<form action="<?= ROOT ?>adminproduct/delete/<?= $data['data']->id ?>" method="POST">
			...
			<div class="form-group text-left">
				...
				<input type="text" name="price" class="form-control" pattern="^(\d\-)?\d*\.?\d*$" placeholder="Escribe el precio del producto sin comas ni símbolos" required value="<?= $data['data']->price ?? '' ?>">
			</div>
