...
<head>
	...
	<script src="https://kit.fontawesome.com/8fd19c5e1a.js" crossorigin="anonymous"></script>
</head>
<body>
				...
				<ul class="navbar-nav navbar-right">
					...
					<li class="nav-item">
						<form action="<?= ROOT ?>search/products" method="POST" class="form-inline">
							...
							<button type="submit" class="btn btn-light" value="Buscar"><i class="fas fa-search"></i></button>
						</form>
					</li>
